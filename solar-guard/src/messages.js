...
// กำลังไฟแสดง 3 ตำแหน่ง ตามที่พ่อเต้ยขอ 4 ส.ค. 2569 — ตอนไล่วัดโหลดทีละตัว
// ความต่างระดับ 0.05 kW มีความหมาย ปัดเหลือตำแหน่งเดียวคือกลบข้อมูลจริงทิ้ง
const kw = (n) => `${(Number(n) || 0).toFixed(3)} kW`;

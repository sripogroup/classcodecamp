...
```
  ✅ 192.168.1.50  รุ่น SUN2000-30KTL-M3  (SN HV2340123456 | ขนาด 30.0 kW)  unit id = 1
```

**ถ้าไม่เจอ** สคริปต์จะบอกสาเหตุที่พบบ่อยให้ เรียงตามโอกาส — ส่วนใหญ่คือ
ยังไม่ได้เปิด Modbus TCP ที่อินเวอร์เตอร์ ไม่ใช่ว่าอยู่คนละวง

> โครงข้อมูล Modbus ในสคริปต์นี้ผ่านการทดสอบกับอินเวอร์เตอร์จำลองแล้ว
> (`python test_find_inverter.py`) ถ้ามันบอกว่าไม่เจอ แปลว่าไม่เจอจริง ๆ
> ไม่ใช่โค้ดผิด
